...
#define TX_INTERRUPT_SAVE_AREA2                  UINT interrupt_save2;
#define TX_DISABLE2                              interrupt_save2 =  __disable_interrupts();
#define TX_RESTORE2                              __restore_interrupt(interrupt_save2);
...
const CHAR  _tx_version_id[] = "Copyright (c) 2024 Microsoft Corporation\r\n*  ThreadX Cortex-M4/GNU Version 6.4.1 *\r\n";
#else
#ifdef TX_MISRA_ENABLE
extern  const CHAR                    _tx_version_id[100];
#else
